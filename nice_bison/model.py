...
class NiceBison(Model):
    ...
    def __init__(self, height=10, width=10, initial_bison=10,
        ...
        for i in range(self.initial_bison):
            ...
            bison = Bison(self.next_id(), (x, y), self, True, energy)
    ...
    def bison_battle(self, grass_amount, bison_one, bison_two):
        ...
        gain_one, gain_two = self.payoff_matrix[bison_one.choose_strategy(bison_two.unique_id)][bison_two.choose_strategy(bison_one.unique_id)]
